...
const Popular = () => {
  ...
  return (
    <div className="w-full flex flex-wrap justify-center">
      <h1 className="w-full text-center p-4 text-5xl font-extrabold">Popular Movies</h1>
    {
      data.map((item:ItemType, id:number) => (
        <div key={id} className="w-[23.5%] m-2 flex flex-wrap justify-center text-center bg-lime-100">
